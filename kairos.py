...
def get_weather():
    try:
        ...
        try:
            ...
            status_text = "ΞΑΣΤΕΡΙΑ.ΑΙΘΡΙΟΣ" if "Αίθριος" in raw or "Καθαρός" in raw else raw.upper()
        except: pass
