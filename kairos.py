...
def get_weather():
    try:
        # 1. RADAR - Φέρνουμε την κατάσταση
        ...
        # 2. OPEN-METEO - Φέρνουμε τα νούμερα
        ...
        # 3. ΔΗΜΙΟΥΡΓΙΑ DATA.JSON - Με όλα τα ονόματα που θέλει η σελίδα σου
        data = {
